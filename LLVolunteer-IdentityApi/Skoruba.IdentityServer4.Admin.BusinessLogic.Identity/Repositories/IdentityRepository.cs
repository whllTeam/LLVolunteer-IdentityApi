...
namespace Skoruba.IdentityServer4.Admin.BusinessLogic.Identity.Repositories
{
        ...
        where TUserToken : IdentityUserToken<TKey>
    {
        ...
        private readonly UserManager<UserIdentity> _userManagerIdentity;
        ...
        public IdentityRepository(TIdentityDbContext dbContext,
            ...
            IMapper mapper,
            UserManager<UserIdentity> userManagerIdentity
            )
        {
        ...
        public async Task<bool> CheckHasUserName(string userName)
        {
            var result = await _userManager.Users.AnyAsync(t => t.UserName == userName);
            return result;
        }

        public async Task<bool> AddUser(UserIdentity user)
        {
            ...
            var result = await _userManagerIdentity.CreateAsync(u);
